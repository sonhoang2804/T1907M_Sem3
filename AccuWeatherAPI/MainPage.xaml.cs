    ...
    public sealed partial class MainPage : Page
    {
            ...
            list.ForEach(it =>
                {
                    ...
                    it.WeatherIcon = string.Format("https://vortex.accuweather.com/adc2010/image/slate/icon/{0}.svg", it.WeatherIcon);
        ...
        private async void InitEachDaysJSON()
        {
            ...
            obj.DailyForeCasts.ForEach(it =>
            {
                ...
                it.Day.Icon = string.Format("https://vortex.accuweather.com/adc2010/image/slate/icon/{0}.svg", it.Day.Icon);
